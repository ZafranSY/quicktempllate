...
const InputPanel: React.FC<InputPanelProps> = ({ onDataChange, onGenerateCard }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col p-6 space-y-6">
        ...
        <div className="w-full">
          ...
          <div className="relative">
            ...
            {isOpen && (
              <div
                className="absolute w-full mt-2 bg-white dark:bg-slate-800 rounded-lg shadow-xl 
              ...
              >
                {languages.map((language) => (
                  ...
                  >
                    <span
                      className={`flex-1 ${
                        formData.language === language ? "text-blue-500 dark:text-blue-400" : ""
                      }`}
                    >
                      {language}
                    </span>
        ...
        <div className="w-full">
          ...
          >
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              ></div>
              <span
                className="absolute left-1 top-1 w-4 h-4 bg-white dark:bg-slate-200 
                rounded-full peer-checked:translate-x-5 transition-transform"
              ></span>
            </label>
          </div>
      ...
      {/* Footer */}
      <div
        className="mt-auto p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm 
